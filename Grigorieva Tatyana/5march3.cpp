...
void clothing_shopping(struct Person* p, RUB amount);
...
void init_events_dynamic() {
    ...
    struct LifeEvent e15;
    strcpy(e15.description, "Сезонная распродажа одежды");
    e15.min_year = 2026;
    e15.max_year = 2027;
    e15.min_month = 3;
    e15.max_month = 4;  // весна
    e15.effect = clothing_shopping;
    e15.probability = 80;
    e15.triggered = 0;
    e15.financial_impact = 0;
    events[num_events++] = e15;
   
    struct LifeEvent e16;
    strcpy(e16.description, "Зимняя распродажа одежды");
    e16.min_year = 2026;
    e16.max_year = 2027;
    e16.min_month = 11;
    e16.max_month = 12;  // зима
    e16.effect = clothing_shopping;
    e16.probability = 85;
    e16.triggered = 0;
    e16.financial_impact = 0;
    events[num_events++] = e16;
    
    struct LifeEvent e17;
    strcpy(e17.description, "Летняя распродажа одежды");
    e17.min_year = 2026;
    e17.max_year = 2027;
    e17.min_month = 6;
    e17.max_month = 7;  // лето
    e17.effect = clothing_shopping;
    e17.probability = 75;
    e17.triggered = 0;
    e17.financial_impact = 0;
    events[num_events++] = e17;
}
...
void clothing_shopping(struct Person* p, RUB amount) {
    RUB cost = 5000 + rand() % 45000;  // 5k - 50k
    printf("\n ПОКУПКА ОДЕЖДЫ\n");
    printf("  Потрачено на одежду: %lld руб.\n", cost);
    
    if (p->bank.card >= cost) {
        p->bank.card -= cost;
        printf("  Оплачено картой\n");
    } else {
        RUB remaining = cost - p->bank.card;
        p->bank.card = 0;
        p->cash -= remaining;
        printf("  Частично оплачено наличными: %lld руб.\n", remaining);
    }
