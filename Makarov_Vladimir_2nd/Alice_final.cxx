...
struct Person {
	...
	Deposit deposit;
	float inflation_rate_food;
	float inflation_rate_household;
	float inflation_rate_utils;
	float inflation_rate_health;
	float inflation_rate_lifestyle;
	float inflation_rate_shopping;
	float inflation_rate_development;
	float inflation_rate_pets;
	float inflation_rate_vacation;
	float inflation_rate_personal;
	int has_mortgage;
	int has_credit;
	RUB haircut;
	RUB coffee_takeaway;
...
void alice_init()
{
	...
	alice.inflation_rate_food = 0.009;
	alice.inflation_rate_household = 0.005; 
	alice.inflation_rate_utils = 0.005;
	alice.inflation_rate_health = 0.012;
	alice.inflation_rate_lifestyle = 0.004;
	alice.inflation_rate_shopping = 0.005;
	alice.inflation_rate_development = 0.005;
	alice.inflation_rate_pets = 0.007;
	alice.inflation_rate_vacation = 0.006;
	alice.inflation_rate_personal = 0.006;
	...
	alice.car.tire_change = 12000; // Резина
	...
	alice.food_stock.carrots = 100;
	alice.food_stock.onion = 150;
	alice.food_stock.garlic = 50;
	alice.food_stock.cabbage = 200;
	alice.food_stock.tomatoes = 500;
	alice.food_stock.cucumbers = 400;
	alice.food_stock.apples = 300;
	alice.food_stock.bananas = 300;
	alice.food_stock.chicken_breast = 600;
	alice.food_stock.pork = 400; // Свининиа
	alice.food_stock.beef = 500;
	alice.food_stock.cheese = 600;
	alice.food_stock.tvorog = 500;
	alice.food_stock.butter = 400;
	alice.food_stock.eggs = 700;
	alice.food_stock.milk = 1000;
	alice.food_stock.vegetable_oil = 250;
	alice.food_stock.tea = 200;
	...
	alice.taxi = 3000;
	alice.cigarettes = 1000;
}

void alice_inflation_food_after()
{
	alice.inflation_rate_food = 0.009;

	alice.food_stock.rice = alice.food_stock.rice * (1 + alice.inflation_rate_food);
	alice.food_stock.buckwheat = alice.food_stock.buckwheat * (1 + alice.inflation_rate_food);
	alice.food_stock.oatmeal = alice.food_stock.oatmeal * (1 + alice.inflation_rate_food);
	alice.food_stock.potatoes = alice.food_stock.potatoes * (1 + alice.inflation_rate_food);
	alice.food_stock.carrots = alice.food_stock.carrots * (1 + alice.inflation_rate_food);
	alice.food_stock.onion = alice.food_stock.onion * (1 + alice.inflation_rate_food);
	alice.food_stock.garlic = alice.food_stock.garlic * (1 + alice.inflation_rate_food);
	alice.food_stock.cabbage = alice.food_stock.cabbage * (1 + alice.inflation_rate_food);
	alice.food_stock.tomatoes = alice.food_stock.tomatoes * (1 + alice.inflation_rate_food);
	alice.food_stock.cucumbers = alice.food_stock.cucumbers * (1 + alice.inflation_rate_food);
	alice.food_stock.apples = alice.food_stock.apples * (1 + alice.inflation_rate_food);
	alice.food_stock.bananas = alice.food_stock.bananas * (1 + alice.inflation_rate_food);
	alice.food_stock.chicken_breast = alice.food_stock.chicken_breast * (1 + alice.inflation_rate_food);
	alice.food_stock.pork = alice.food_stock.pork * (1 + alice.inflation_rate_food);
	alice.food_stock.beef = alice.food_stock.beef * (1 + alice.inflation_rate_food);
	alice.food_stock.cheese = alice.food_stock.cheese * (1 + alice.inflation_rate_food);
	alice.food_stock.tvorog = alice.food_stock.tvorog * (1 + alice.inflation_rate_food);
	alice.food_stock.butter = alice.food_stock.butter * (1 + alice.inflation_rate_food);
	alice.food_stock.eggs = alice.food_stock.eggs * (1 + alice.inflation_rate_food);
	alice.food_stock.milk = alice.food_stock.milk * (1 + alice.inflation_rate_food);
	alice.food_stock.vegetable_oil = alice.food_stock.vegetable_oil * (1 + alice.inflation_rate_food);
	alice.food_stock.tea = alice.food_stock.tea * (1 + alice.inflation_rate_food);
	alice.food_stock.coffee = alice.food_stock.coffee * (1 + alice.inflation_rate_food);
	alice.food_stock.salt = alice.food_stock.salt * (1 + alice.inflation_rate_food);
	alice.food_stock.pepper = alice.food_stock.pepper * (1 + alice.inflation_rate_food);
	alice.food_stock.sugar = alice.food_stock.sugar * (1 + alice.inflation_rate_food);
	alice.food_stock.flour = alice.food_stock.flour * (1 + alice.inflation_rate_food);
	alice.food_stock.pasta = alice.food_stock.pasta * (1 + alice.inflation_rate_food);
	alice.food_stock.canned_food = alice.food_stock.canned_food * (1 + alice.inflation_rate_food);
	alice.food_stock.fish = alice.food_stock.fish * (1 + alice.inflation_rate_food);
	alice.food_stock.sausage = alice.food_stock.sausage * (1 + alice.inflation_rate_food);
	alice.food_stock.bread = alice.food_stock.bread * (1 + alice.inflation_rate_food);
	alice.food_stock.juice = alice.food_stock.juice * (1 + alice.inflation_rate_food);
	alice.food_stock.water = alice.food_stock.water * (1 + alice.inflation_rate_food);
	alice.food_stock.honey = alice.food_stock.honey * (1 + alice.inflation_rate_food);
	alice.food_stock.nuts = alice.food_stock.nuts * (1 + alice.inflation_rate_food);
	alice.food_stock.dried_fruits = alice.food_stock.dried_fruits * (1 + alice.inflation_rate_food);
}

void alice_inflation_household_after()
{
	alice.inflation_rate_household = 0.005;

	alice.household.washing_powder = alice.household.washing_powder * (1 + alice.inflation_rate_household);
	alice.household.toilet_paper = alice.household.toilet_paper * (1 + alice.inflation_rate_household);
	alice.household.toothpaste = alice.household.toothpaste * (1 + alice.inflation_rate_household);
	alice.household.toothbrush = alice.household.toothbrush * (1 + alice.inflation_rate_household);
	alice.household.deodorant = alice.household.deodorant * (1 + alice.inflation_rate_household);
	alice.household.shower_gel = alice.household.shower_gel * (1 + alice.inflation_rate_household);
	alice.household.shampoo = alice.household.shampoo * (1 + alice.inflation_rate_household);
	alice.household.razor = alice.household.razor * (1 + alice.inflation_rate_household);
	alice.household.dish_soap = alice.household.dish_soap * (1 + alice.inflation_rate_household);
	alice.household.trash_bags = alice.household.trash_bags * (1 + alice.inflation_rate_household);
	alice.household.paper_towels = alice.household.paper_towels * (1 + alice.inflation_rate_household);
	alice.household.laundry_softener = alice.household.laundry_softener * (1 + alice.inflation_rate_household);
	alice.household.cleaning_spray = alice.household.cleaning_spray * (1 + alice.inflation_rate_household);
	alice.household.sponge = alice.household.sponge * (1 + alice.inflation_rate_household);
	alice.household.batteries = alice.household.batteries * (1 + alice.inflation_rate_household);
	alice.household.foil = alice.household.foil * (1 + alice.inflation_rate_household);
	alice.household.cling_film = alice.household.cling_film * (1 + alice.inflation_rate_household);
}

void alice_inflation_utils_after()
{
	alice.inflation_rate_utils = 0.005;

	alice.utils.electricity = alice.utils.electricity * (1 + alice.inflation_rate_utils);
	alice.utils.water_cold = alice.utils.water_cold * (1 + alice.inflation_rate_utils);
	alice.utils.water_hot = alice.utils.water_hot * (1 + alice.inflation_rate_utils);
	alice.utils.capital_repair = alice.utils.capital_repair * (1 + alice.inflation_rate_utils);
	alice.utils.garbage = alice.utils.garbage * (1 + alice.inflation_rate_utils);
	alice.utils.internet = alice.utils.internet * (1 + alice.inflation_rate_utils);
	alice.utils.intercom = alice.utils.intercom * (1 + alice.inflation_rate_utils);
	alice.utils.gas_supply = alice.utils.gas_supply * (1 + alice.inflation_rate_utils);
	alice.utils.sewer = alice.utils.sewer * (1 + alice.inflation_rate_utils);
	alice.utils.tv = alice.utils.tv * (1 + alice.inflation_rate_utils);
}

void alice_inflation_health_after()
{
	alice.inflation_rate_health = 0.012;

	alice.health.medicines = alice.health.medicines * (1 + alice.inflation_rate_health);
	alice.health.vitamins = alice.health.vitamins * (1 + alice.inflation_rate_health);
	alice.health.omega3 = alice.health.omega3 * (1 + alice.inflation_rate_health);
	alice.health.vitamin_d = alice.health.vitamin_d * (1 + alice.inflation_rate_health);
	alice.health.magnesium = alice.health.magnesium * (1 + alice.inflation_rate_health);
	alice.health.zinc = alice.health.zinc * (1 + alice.inflation_rate_health);
	alice.health.iron = alice.health.iron * (1 + alice.inflation_rate_health);
	alice.health.calcium = alice.health.calcium * (1 + alice.inflation_rate_health);
	alice.health.collagen = alice.health.collagen * (1 + alice.inflation_rate_health);
	alice.health.probiotics = alice.health.probiotics * (1 + alice.inflation_rate_health);
	alice.health.eye_drops = alice.health.eye_drops * (1 + alice.inflation_rate_health);
	alice.health.cream = alice.health.cream * (1 + alice.inflation_rate_health);
}

void alice_inflation_lifestyle_after()
{
	alice.inflation_rate_lifestyle = 0.004;

	alice.lifestyle.cinema = alice.lifestyle.cinema * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.restaurant = alice.lifestyle.restaurant * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.bar = alice.lifestyle.bar * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.billiards = alice.lifestyle.billiards * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.bowling = alice.lifestyle.bowling * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.theater = alice.lifestyle.theater * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.quest = alice.lifestyle.quest * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.concert = alice.lifestyle.concert * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.museum = alice.lifestyle.museum * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.hookah = alice.lifestyle.hookah * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.ice_skating = alice.lifestyle.ice_skating * (1 + alice.inflation_rate_lifestyle);
	alice.lifestyle.skiing = alice.lifestyle.skiing * (1 + alice.inflation_rate_lifestyle);
}

void alice_inflation_shopping_after()
{
	alice.inflation_rate_shopping = 0.005;

	alice.shopping.clothes = alice.shopping.clothes * (1 + alice.inflation_rate_shopping);
	alice.shopping.shoes = alice.shopping.shoes * (1 + alice.inflation_rate_shopping);
	alice.shopping.accessories = alice.shopping.accessories * (1 + alice.inflation_rate_shopping);
	alice.shopping.electronics = alice.shopping.electronics * (1 + alice.inflation_rate_shopping);
	alice.shopping.cosmetics = alice.shopping.cosmetics * (1 + alice.inflation_rate_shopping);
	alice.shopping.tools = alice.shopping.tools * (1 + alice.inflation_rate_shopping);
	alice.shopping.home_goods = alice.shopping.home_goods * (1 + alice.inflation_rate_shopping);
	alice.shopping.sport_equipment = alice.shopping.sport_equipment * (1 + alice.inflation_rate_shopping);
	alice.shopping.backpack = alice.shopping.backpack * (1 + alice.inflation_rate_shopping);
	alice.shopping.watch = alice.shopping.watch * (1 + alice.inflation_rate_shopping);
	alice.shopping.perfume = alice.shopping.perfume * (1 + alice.inflation_rate_shopping);
}

void alice_inflation_development_after()
{
	alice.inflation_rate_development = 0.005;

	alice.development.yandex_plus = alice.development.yandex_plus * (1 + alice.inflation_rate_development);
	alice.development.t2 = alice.development.t2 * (1 + alice.inflation_rate_development);
	alice.development.youtube_premium = alice.development.youtube_premium * (1 + alice.inflation_rate_development);
	alice.development.books = alice.development.books * (1 + alice.inflation_rate_development);
	alice.development.courses = alice.development.courses * (1 + alice.inflation_rate_development);
	alice.development.english = alice.development.english * (1 + alice.inflation_rate_development);
	alice.development.programming = alice.development.programming * (1 + alice.inflation_rate_development);
	alice.development.audiobooks = alice.development.audiobooks * (1 + alice.inflation_rate_development);
}

void alice_inflation_pets_after()
{
	alice.inflation_rate_pets = 0.007;

	alice.pets.cat_food = alice.pets.cat_food * (1 + alice.inflation_rate_pets);
	alice.pets.cat_litter = alice.pets.cat_litter * (1 + alice.inflation_rate_pets);
	alice.pets.cat_vet = alice.pets.cat_vet * (1 + alice.inflation_rate_pets);
	alice.pets.cat_toys = alice.pets.cat_toys * (1 + alice.inflation_rate_pets);
	alice.pets.dog_food = alice.pets.dog_food * (1 + alice.inflation_rate_pets);
	alice.pets.dog_vet = alice.pets.dog_vet * (1 + alice.inflation_rate_pets);
	alice.pets.dog_toys = alice.pets.dog_toys * (1 + alice.inflation_rate_pets);
	alice.pets.dog_walker = alice.pets.dog_walker * (1 + alice.inflation_rate_pets);
	alice.pets.pet_insurance = alice.pets.pet_insurance * (1 + alice.inflation_rate_pets);
}

void alice_inflation_vacation_after()
{
	alice.inflation_rate_vacation = 0.006;

	alice.vacation.summer_trip = alice.vacation.summer_trip * (1 + alice.inflation_rate_vacation);
	alice.vacation.winter_trip = alice.vacation.winter_trip * (1 + alice.inflation_rate_vacation);
	alice.vacation.weekend_trips = alice.vacation.weekend_trips * (1 + alice.inflation_rate_vacation);
	alice.vacation.visa = alice.vacation.visa * (1 + alice.inflation_rate_vacation);
	alice.vacation.insurance = alice.vacation.insurance * (1 + alice.inflation_rate_vacation);
	alice.vacation.equipment = alice.vacation.equipment * (1 + alice.inflation_rate_vacation);
	alice.vacation.souvenirs = alice.vacation.souvenirs * (1 + alice.inflation_rate_vacation);
}

void alice_inflation_personal_after()
{
	alice.inflation_rate_personal = 0.006;

	alice.haircut = alice.haircut * (1 + alice.inflation_rate_personal);
	alice.coffee_takeaway = alice.coffee_takeaway * (1 + alice.inflation_rate_personal);
	alice.lunch_work = alice.lunch_work * (1 + alice.inflation_rate_personal);
	alice.psychologist = alice.psychologist * (1 + alice.inflation_rate_personal);
	alice.manicure = alice.manicure * (1 + alice.inflation_rate_personal);
	alice.cosmetologist = alice.cosmetologist * (1 + alice.inflation_rate_personal);
	alice.taxi = alice.taxi * (1 + alice.inflation_rate_personal);
	alice.cigarettes = alice.cigarettes * (1 + alice.inflation_rate_personal);
}
	  
void alice_utils_jan()
{
...
void alice_personal_expenses(int month) // Личные расходы
{
	...
	alice.bank.account_rub -= alice.cigarettes;
	if (month == 1 || month == 3 || month == 5 || month == 7 || month == 9 || month == 11) {
...
void alice_simulation()
{
	...
	while (!(year == 2029 && month == 2)) {
		...
		alice_inflation_food_after();
		alice_inflation_household_after();
		alice_inflation_utils_after();
		alice_inflation_health_after();
		alice_inflation_lifestyle_after();
		alice_inflation_shopping_after();
		alice_inflation_development_after();
		alice_inflation_pets_after();
		alice_inflation_vacation_after();
		alice_inflation_personal_after();
		...
		if (month == 1) { alice_utils_jan(); }
		if (month == 2) { alice_utils_feb(); }
		if (month == 3) { alice_utils_mar(); }
		if (month == 4) { alice_utils_apr(); }
		if (month == 5) { alice_utils_may(); }
		if (month == 6) { alice_utils_jun(); }
		if (month == 7) { alice_utils_jul(); }
		if (month == 8) { alice_utils_aug(); }
		if (month == 9) { alice_utils_sep(); }
		if (month == 10) { alice_utils_oct(); }
		if (month == 11) { alice_utils_nov(); }
		if (month == 12) { alice_utils_dec(); }
...
void den_init()
{
	...
	den.inflation_rate_food = 0.009;
	den.inflation_rate_household = 0.005;
	den.inflation_rate_utils = 0.005;
	den.inflation_rate_health = 0.012;
	den.inflation_rate_lifestyle = 0.004;
	den.inflation_rate_shopping = 0.005;
	den.inflation_rate_development = 0.005;
	den.inflation_rate_pets = 0.007;
	den.inflation_rate_vacation = 0.006;
	den.inflation_rate_personal = 0.006;
	den.has_mortgage = 1;
	den.has_credit = 0;
...
void den_inflation_food_after()
{
	den.food_stock.rice = den.food_stock.rice * (1 + den.inflation_rate_food);
	den.food_stock.buckwheat = den.food_stock.buckwheat * (1 + den.inflation_rate_food);
	den.food_stock.oatmeal = den.food_stock.oatmeal * (1 + den.inflation_rate_food);
	den.food_stock.potatoes = den.food_stock.potatoes * (1 + den.inflation_rate_food);
	den.food_stock.carrots = den.food_stock.carrots * (1 + den.inflation_rate_food);
	den.food_stock.onion = den.food_stock.onion * (1 + den.inflation_rate_food);
	den.food_stock.garlic = den.food_stock.garlic * (1 + den.inflation_rate_food);
	den.food_stock.cabbage = den.food_stock.cabbage * (1 + den.inflation_rate_food);
	den.food_stock.tomatoes = den.food_stock.tomatoes * (1 + den.inflation_rate_food);
	den.food_stock.cucumbers = den.food_stock.cucumbers * (1 + den.inflation_rate_food);
	den.food_stock.apples = den.food_stock.apples * (1 + den.inflation_rate_food);
	den.food_stock.bananas = den.food_stock.bananas * (1 + den.inflation_rate_food);
	den.food_stock.chicken_breast = den.food_stock.chicken_breast * (1 + den.inflation_rate_food);
	den.food_stock.pork = den.food_stock.pork * (1 + den.inflation_rate_food);
	den.food_stock.beef = den.food_stock.beef * (1 + den.inflation_rate_food);
	den.food_stock.cheese = den.food_stock.cheese * (1 + den.inflation_rate_food);
	den.food_stock.tvorog = den.food_stock.tvorog * (1 + den.inflation_rate_food);
	den.food_stock.butter = den.food_stock.butter * (1 + den.inflation_rate_food);
	den.food_stock.eggs = den.food_stock.eggs * (1 + den.inflation_rate_food);
	den.food_stock.milk = den.food_stock.milk * (1 + den.inflation_rate_food);
	den.food_stock.vegetable_oil = den.food_stock.vegetable_oil * (1 + den.inflation_rate_food);
	den.food_stock.tea = den.food_stock.tea * (1 + den.inflation_rate_food);
	den.food_stock.coffee = den.food_stock.coffee * (1 + den.inflation_rate_food);
	den.food_stock.salt = den.food_stock.salt * (1 + den.inflation_rate_food);
	den.food_stock.pepper = den.food_stock.pepper * (1 + den.inflation_rate_food);
	den.food_stock.sugar = den.food_stock.sugar * (1 + den.inflation_rate_food);
	den.food_stock.flour = den.food_stock.flour * (1 + den.inflation_rate_food);
	den.food_stock.pasta = den.food_stock.pasta * (1 + den.inflation_rate_food);
	den.food_stock.canned_food = den.food_stock.canned_food * (1 + den.inflation_rate_food);
	den.food_stock.fish = den.food_stock.fish * (1 + den.inflation_rate_food);
	den.food_stock.sausage = den.food_stock.sausage * (1 + den.inflation_rate_food);
	den.food_stock.bread = den.food_stock.bread * (1 + den.inflation_rate_food);
	den.food_stock.juice = den.food_stock.juice * (1 + den.inflation_rate_food);
	den.food_stock.water = den.food_stock.water * (1 + den.inflation_rate_food);
	den.food_stock.honey = den.food_stock.honey * (1 + den.inflation_rate_food);
	den.food_stock.nuts = den.food_stock.nuts * (1 + den.inflation_rate_food);
	den.food_stock.dried_fruits = den.food_stock.dried_fruits * (1 + den.inflation_rate_food);
}

void den_inflation_household_after()
{
	den.household.washing_powder = den.household.washing_powder * (1 + den.inflation_rate_household);
	den.household.toilet_paper = den.household.toilet_paper * (1 + den.inflation_rate_household);
	den.household.toothpaste = den.household.toothpaste * (1 + den.inflation_rate_household);
	den.household.toothbrush = den.household.toothbrush * (1 + den.inflation_rate_household);
	den.household.deodorant = den.household.deodorant * (1 + den.inflation_rate_household);
	den.household.shower_gel = den.household.shower_gel * (1 + den.inflation_rate_household);
	den.household.shampoo = den.household.shampoo * (1 + den.inflation_rate_household);
	den.household.razor = den.household.razor * (1 + den.inflation_rate_household);
	den.household.dish_soap = den.household.dish_soap * (1 + den.inflation_rate_household);
	den.household.trash_bags = den.household.trash_bags * (1 + den.inflation_rate_household);
	den.household.paper_towels = den.household.paper_towels * (1 + den.inflation_rate_household);
	den.household.laundry_softener = den.household.laundry_softener * (1 + den.inflation_rate_household);
	den.household.cleaning_spray = den.household.cleaning_spray * (1 + den.inflation_rate_household);
	den.household.sponge = den.household.sponge * (1 + den.inflation_rate_household);
	den.household.batteries = den.household.batteries * (1 + den.inflation_rate_household);
	den.household.foil = den.household.foil * (1 + den.inflation_rate_household);
	den.household.cling_film = den.household.cling_film * (1 + den.inflation_rate_household);
}

void den_inflation_utils_after()
{
	den.utils.electricity = den.utils.electricity * (1 + den.inflation_rate_utils);
	den.utils.water_cold = den.utils.water_cold * (1 + den.inflation_rate_utils);
	den.utils.water_hot = den.utils.water_hot * (1 + den.inflation_rate_utils);
	den.utils.capital_repair = den.utils.capital_repair * (1 + den.inflation_rate_utils);
	den.utils.garbage = den.utils.garbage * (1 + den.inflation_rate_utils);
	den.utils.internet = den.utils.internet * (1 + den.inflation_rate_utils);
	den.utils.intercom = den.utils.intercom * (1 + den.inflation_rate_utils);
	den.utils.gas_supply = den.utils.gas_supply * (1 + den.inflation_rate_utils);
	den.utils.sewer = den.utils.sewer * (1 + den.inflation_rate_utils);
	den.utils.tv = den.utils.tv * (1 + den.inflation_rate_utils);
}

void den_inflation_health_after()
{
	den.health.medicines = den.health.medicines * (1 + den.inflation_rate_health);
	den.health.vitamins = den.health.vitamins * (1 + den.inflation_rate_health);
}

void den_inflation_lifestyle_after()
{
	den.lifestyle.cinema = den.lifestyle.cinema * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.restaurant = den.lifestyle.restaurant * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.bar = den.lifestyle.bar * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.billiards = den.lifestyle.billiards * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.bowling = den.lifestyle.bowling * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.theater = den.lifestyle.theater * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.quest = den.lifestyle.quest * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.concert = den.lifestyle.concert * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.museum = den.lifestyle.museum * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.hookah = den.lifestyle.hookah * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.ice_skating = den.lifestyle.ice_skating * (1 + den.inflation_rate_lifestyle);
	den.lifestyle.skiing = den.lifestyle.skiing * (1 + den.inflation_rate_lifestyle);
}

void den_inflation_shopping_after()
{
	den.shopping.clothes = den.shopping.clothes * (1 + den.inflation_rate_shopping);
	den.shopping.shoes = den.shopping.shoes * (1 + den.inflation_rate_shopping);
	den.shopping.accessories = den.shopping.accessories * (1 + den.inflation_rate_shopping);
	den.shopping.electronics = den.shopping.electronics * (1 + den.inflation_rate_shopping);
	den.shopping.cosmetics = den.shopping.cosmetics * (1 + den.inflation_rate_shopping);
	den.shopping.tools = den.shopping.tools * (1 + den.inflation_rate_shopping);
	den.shopping.home_goods = den.shopping.home_goods * (1 + den.inflation_rate_shopping);
	den.shopping.sport_equipment = den.shopping.sport_equipment * (1 + den.inflation_rate_shopping);
	den.shopping.backpack = den.shopping.backpack * (1 + den.inflation_rate_shopping);
	den.shopping.watch = den.shopping.watch * (1 + den.inflation_rate_shopping);
	den.shopping.perfume = den.shopping.perfume * (1 + den.inflation_rate_shopping);
}

void den_inflation_development_after()
{
	den.development.yandex_plus = den.development.yandex_plus * (1 + den.inflation_rate_development);
	den.development.t2 = den.development.t2 * (1 + den.inflation_rate_development);
	den.development.youtube_premium = den.development.youtube_premium * (1 + den.inflation_rate_development);
	den.development.books = den.development.books * (1 + den.inflation_rate_development);
	den.development.courses = den.development.courses * (1 + den.inflation_rate_development);
	den.development.english = den.development.english * (1 + den.inflation_rate_development);
	den.development.programming = den.development.programming * (1 + den.inflation_rate_development);
	den.development.audiobooks = den.development.audiobooks * (1 + den.inflation_rate_development);
}

void den_inflation_pets_after()
{
	den.pets.cat_food = den.pets.cat_food * (1 + den.inflation_rate_pets);
	den.pets.cat_litter = den.pets.cat_litter * (1 + den.inflation_rate_pets);
	den.pets.cat_vet = den.pets.cat_vet * (1 + den.inflation_rate_pets);
	den.pets.cat_toys = den.pets.cat_toys * (1 + den.inflation_rate_pets);
	den.pets.dog_food = den.pets.dog_food * (1 + den.inflation_rate_pets);
	den.pets.dog_vet = den.pets.dog_vet * (1 + den.inflation_rate_pets);
	den.pets.dog_toys = den.pets.dog_toys * (1 + den.inflation_rate_pets);
	den.pets.dog_walker = den.pets.dog_walker * (1 + den.inflation_rate_pets);
	den.pets.pet_insurance = den.pets.pet_insurance * (1 + den.inflation_rate_pets);
}

void den_inflation_vacation_after()
{
	den.vacation.summer_trip = den.vacation.summer_trip * (1 + den.inflation_rate_vacation);
	den.vacation.winter_trip = den.vacation.winter_trip * (1 + den.inflation_rate_vacation);
	den.vacation.weekend_trips = den.vacation.weekend_trips * (1 + den.inflation_rate_vacation);
	den.vacation.visa = den.vacation.visa * (1 + den.inflation_rate_vacation);
	den.vacation.insurance = den.vacation.insurance * (1 + den.inflation_rate_vacation);
	den.vacation.equipment = den.vacation.equipment * (1 + den.inflation_rate_vacation);
	den.vacation.souvenirs = den.vacation.souvenirs * (1 + den.inflation_rate_vacation);
}

void den_inflation_personal_after()
{
	den.haircut = den.haircut * (1 + den.inflation_rate_personal);
	den.lunch_work = den.lunch_work * (1 + den.inflation_rate_personal);
	den.gifts = den.gifts * (1 + den.inflation_rate_personal);
}
...
void den_simulation()
{
	...
	int month = 2;
	while (!(year == 2029 && month == 2)) {
		den_inflation_food_after();
		den_inflation_household_after();
		den_inflation_utils_after();
		den_inflation_health_after();
		den_inflation_lifestyle_after();
		den_inflation_shopping_after();
		den_inflation_development_after();
		den_inflation_pets_after();
		den_inflation_vacation_after();
		den_inflation_personal_after();
		...
		if (month == 1) { den_utils_jan(); }
		if (month == 2) { den_utils_feb(); }
		if (month == 3) { den_utils_mar(); }
		if (month == 4) { den_utils_apr(); }
		if (month == 5) { den_utils_may(); }
		if (month == 6) { den_utils_jun(); }
		if (month == 7) { den_utils_jul(); }
		if (month == 8) { den_utils_aug(); }
		if (month == 9) { den_utils_sep(); }
		if (month == 10) { den_utils_oct(); }
		if (month == 11) { den_utils_nov(); }
		if (month == 12) { den_utils_dec(); }
		if (month == 1 || month == 4 || month == 7 || month == 10) {
