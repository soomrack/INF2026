...
//typedef int RUB; //  лючевое слово, зарезервировано под функции €зыка, используют в —
using RUB = long long int; // »спользуют в —++, можно из одного места помен€ть типы данных многих переменных
...
// long int - int хранит 4 байта, а не 2, в принте надо мен€ть отдельно
