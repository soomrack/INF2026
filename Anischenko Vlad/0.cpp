...
static RUB estimate_monthly_income(const person& p) {
    static int month_counter = 0;
    month_counter = (month_counter + 1) % 3;
    RUB bonus = (month_counter == 0) ? random_int(0, 12000) : 0;
    return p.salary + p.side_income + bonus;
}

static RUB estimate_monthly_income_after_tax(const person& p, int year_index, double employment_factor) {
    RUB gross = estimate_monthly_income(p);
...
static RUB estimate_monthly_income_after_tax(const person& p, int year_index) {
    return estimate_monthly_income_after_tax(p, year_index, 1.0);
}
...
const unsigned char DIARY_ACTIONS[] = {
    ACT_REST, ACT_REST, ACT_REST, ACT_REST, ACT_STUDY, ACT_REST, ACT_FAMILY, ACT_REST, ACT_REST, ACT_STUDY,
    ACT_GYM, ACT_REST, ACT_REST, ACT_FAMILY, ACT_STUDY, ACT_REST, ACT_REST, ACT_REST, ACT_REST, ACT_STUDY,
    ACT_FAMILY, ACT_GYM, ACT_REST, ACT_REST, ACT_STUDY, ACT_REST, ACT_REST, ACT_FAMILY, ACT_REST, ACT_STUDY,
    ACT_REST, ACT_REST, ACT_GYM, ACT_REST, ACT_FAMILY, ACT_REST, ACT_REST, ACT_REST, ACT_REST, ACT_STUDY,
    ACT_REST, ACT_FAMILY, ACT_REST, ACT_GYM, ACT_STUDY, ACT_REST, ACT_REST, ACT_REST, ACT_FAMILY, ACT_STUDY,
    ACT_REST, ACT_REST, ACT_TRAVEL, ACT_REST, ACT_GYM, ACT_FAMILY, ACT_REST, ACT_REST, ACT_REST, ACT_STUDY,
    ACT_REST, ACT_REST, ACT_FAMILY, ACT_REST, ACT_STUDY, ACT_GYM, ACT_REST, ACT_REST, ACT_REST, ACT_FAMILY,
    ACT_REST, ACT_REST, ACT_REST, ACT_REST, ACT_STUDY, ACT_REST, ACT_GYM, ACT_REST, ACT_REST, ACT_STUDY,
    ACT_REST, ACT_REST, ACT_REST, ACT_FAMILY, ACT_STUDY, ACT_REST, ACT_REST, ACT_GYM, ACT_REST, ACT_STUDY,
    ACT_FAMILY, ACT_REST, ACT_REST, ACT_REST, ACT_STUDY, ACT_REST, ACT_SICK, ACT_FAMILY, ACT_GYM, ACT_STUDY
};
...
static life_year_report simulate_year(person& p, int year_index) {
    ...
    for (int month = 1; month <= 12; ++month) {
        ...
        RUB month_income = estimate_monthly_income_after_tax(p, year_index, employment_factor);
        ...
        RUB month_due = estimate_monthly_expenses(p, year_index);
        ...
        if (DIARY_DAYS > 0) {
            for (int day = 0; day < 30; ++day) {
                int day_of_life = year_index * 365 + (month - 1) * 30 + day;
                unsigned char act = DIARY_ACTIONS[day_of_life % DIARY_DAYS];
